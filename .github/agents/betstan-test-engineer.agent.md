...
For ingress-at-zero maintenance and fenced-recovery changes, execute the real
deployment shell segment with the real Mongo helper under controlled fakes,
