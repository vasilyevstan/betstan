...
require_literal "$oci_rollback_workflow" "actions/checkout@fbc6f3992d24b796d5a048ff273f7fcc4a7b6c09" "reviewed OCI rollback checkout pin"
require_literal "$oci_rollback_workflow" "actions/download-artifact@37930b1c2abaa49bbe596cd826c3c89aef350131" "reviewed download-artifact pin"
...
require_literal "$oci_rollback_workflow" "actions/upload-artifact@b7c566a772e6b6bfb58ed0dc250532a479d7789f" "reviewed OCI rollback upload-artifact pin"
